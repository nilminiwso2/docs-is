...
2.  Run the `update-geolocation-data.sh` file using the command below.
    ...
    - For MacOS  : [update-geolocation-data.sh]({{base_path}}/assets/attachments/learn/geo-location/mac/update-geolocation-data.sh)

    - For Linux  : [update-geolocation-data.sh]({{base_path}}/assets/attachments/learn/geo-location/linux/update-geolocation-data.sh)
